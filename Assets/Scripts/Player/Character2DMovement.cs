...
public class Character2DMovement : MonoBehaviour
{
    ...
    void AnimateCharacter()
    {
	    ...
	    if (animator != null)
	    {
			...
			// Rotate character according to movemenet direction
			if(mInput.move.x != 0) {
				mHeadingRight = mInput.move.x == 1;
			}
			transform.localScale = new Vector2(mHeadingRight ? 1 : -1, transform.localScale.y);
